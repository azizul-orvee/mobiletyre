      ...
      <section className="bg-white-500 text-black h-screen">
        <div className="container mx-auto px-4 flex flex-col md:flex-row py-10">
          ...
          <div className="md:w-1/2 flex justify-center items-center text-center">
            <div>
              <h1 className="text-4xl font-bold mt-8 text-gray-900">Mobile <span className="text-orange-600">Tyre</span>  Fitting</h1>
              <p className="text-lg m-4 mx-6 text-gray-900">
              Our mobile tire fitting service brings convenience to your doorstep.
               We offer expert tire installation, balancing, and alignment at a location
                of your choice. Say goodbye to the hassle of visiting a garage –
                 we will ensure your tires are professionally fitted, keeping you safe on the road.
              </p>
            </div>
          </div>
        </div>
